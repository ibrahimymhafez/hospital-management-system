...
class SignUpView(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.controller.title("SignUp Window")
        ...
        self.form_frame.grid_rowconfigure(6 , weight=2)
        self.form_frame.grid_rowconfigure(7 , weight=2)
        self.form_frame.grid_rowconfigure(8 , weight=0)
        self.form_frame.grid_rowconfigure(9 , weight=0)
        ...
        self.sign_up_button.grid(row=7 , column=0 , sticky="nsew" , padx= 20 , pady=20)

        self.have_account_frame = ctk.CTkFrame(self.form_frame , fg_color="transparent")
        self.have_account_frame.grid(row=8 , column=0 , sticky="nsew" , padx= 20)
        ...
        self.have_account_label = ctk.CTkLabel(self.have_account_frame , text="Already have an account?" , font=("Aptos", 15) , text_color="#00A9B0")
