...
class LoginView(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.hospital_image = PIL.Image.open("tkinter-main/assets/images/hospital_image.png")
        ...
        self.hospital_logo = PIL.Image.open("tkinter-main/assets/images/hos_logo.png")
